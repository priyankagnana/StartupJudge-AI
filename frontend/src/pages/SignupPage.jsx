    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="bg-surface border border-border rounded-2xl p-8">
          <h1 className="text-2xl font-bold tracking-tight text-text-primary mb-1">Create your account</h1>
          <p className="text-text-muted text-sm mb-8">Start evaluating your startup ideas</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="text-text-secondary text-sm font-medium mb-1.5 block">Name</label>
              <input
                type="text"
                value={name}
        ...
        <p className="text-center text-text-muted text-sm mt-6">
          ...
          <Link to="/login" className="text-accent hover:text-accent-hover font-medium no-underline">
            Sign in
          </Link>
        </p>
      </motion.div>
